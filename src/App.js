...
import abi from "./contracts/WRCoinContract.json";
...
function App() {
  ...
  const contractAddress = '0x8F3Ad53C00E60d0319e81ef4de20F9Bc8E8b13c4';
  ...
  return (
    <main className="main-container">
      <h2 className="headline">
        <span className="headline-gradient">WRCoin Bank</span>
        <img className="inline p-3 ml-6" src="https://i.postimg.cc/MT8z0yc6/3dgifmaker97752.gif" alt="WRCoin" width="150" height="150" />
      </h2>
